...
`
```
This will: 1. Build the Docker image from the provided
```
Dockerfile
```
...
`
```
This will: 1. Pull the pre-built image
```
...
all
```
, depending on your configuration). 2. Start the container and expose it on
```
http://localhost:11235
```
.
